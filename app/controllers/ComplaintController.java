...
//    }
    ...
    public CompletionStage<Result> getWaterChartComplaints() {
        String Category = "Water";
        return complaintRepository.conditionlist2(Category).thenApplyAsync(complaintStream -> {
            return ok(toJson(complaintStream.collect(Collectors.toList())));
        }, ec.current());
    }
    public CompletionStage<Result> getRoadChartComplaints() {
    ...
    public CompletionStage<Result> getGarbageChartComplaints() {
    ...
    public CompletionStage<Result> getElectricityChartComplaints() {
    ...
    public CompletionStage<Result> getWaterComplaints() {
        String Status = "Closed";
        String Category="Water";
        return complaintRepository.conditionlist1(Status,Category).thenApplyAsync(complaintStream -> {
            return ok(toJson(complaintStream.collect(Collectors.toList())));
        }, ec.current());
    }
    public CompletionStage<Result> getGarbageComplaints() {
        String Status = "Closed";
        String Category="Garbage";
        return complaintRepository.conditionlist1(Status,Category).thenApplyAsync(complaintStream -> {
            return ok(toJson(complaintStream.collect(Collectors.toList())));
    ...
    public CompletionStage<Result> getRoadComplaints() {
        String Status = "Closed";
        String Category="Road";
        return complaintRepository.conditionlist1(Status,Category).thenApplyAsync(complaintStream -> {
            return ok(toJson(complaintStream.collect(Collectors.toList())));
    ...
    public CompletionStage<Result> getElectricityComplaints() {
        String Status = "Closed";
        String Category="Electricity";
        return complaintRepository.conditionlist1(Status,Category).thenApplyAsync(complaintStream -> {
            return ok(toJson(complaintStream.collect(Collectors.toList())));
