...
@Override
    ...
    /*public CompletionStage<Integer> addfeedback(String Name,String Email,String message,Long rating) {
...
/*@Override
    public  CompletionStage<Feedback> addfeedback(Feedback feedback) {
        return supplyAsync(() -> wrap(em -> insertt(em, feedback)), executionContext);
    }*/
    ...
    /*private Feedback insertt(EntityManager em, Feedback feedback) {
        em.persist(feedback);
        return feedback;
    }*/
